...
namespace BallonGame
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Vector2 overPosition = new Vector2(WINDOW_WIDTH / 12 * 5, WINDOW_HEIGHT / 2);
        Vector2 displayPosition = new Vector2(WINDOW_WIDTH / 24 * 5 , WINDOW_HEIGHT / 12 * 4);
        // Score handling
        int score = 0;
        int miss = 0;
        string scoreString;
        ...
        protected override void LoadContent()
        {
            ...
            finalString = "Your total score is " + score + " points, and you have missed " + miss + " ballons"; 
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            // check if the game is over, if so display the final results
            if (score + miss >= TOTAL_NUM)
            {
                finalString = "Your total score is " + score + " points, and you have missed " + miss + " ballons";
            }
            else
            {
                ...
                // Generate a ballon every random 1~2 seconds
                ...
                if (eclipseTime >= TOTAL_ECLIPSE_TIME)
                {
                    ...
                    double v = VELOCITY_RANGE * random.NextDouble() + 0.1;
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.DrawString(font, overString, overPosition, Color.Black);
                spriteBatch.DrawString(font, finalString, displayPosition, Color.Black);
            }
                spriteBatch.End();
            base.Draw(gameTime);
        }
